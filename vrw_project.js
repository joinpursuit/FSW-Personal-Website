const jokesRepo = document.querySelector("#jokes-github-link");
...
jokesRepo.addEventListener("mouseleave", (e) => {
    e.target.style.backgroundColor = "#ECECFA";
})

const diceRepo = document.querySelector("#dice-github-link");
...
const cntctLink = document.querySelector("#contact-link");

cntctLink.addEventListener("mouseenter", (e) => {
    e.target.style.textShadow = "1px 1px 2px #8bbbae, 0 0 25px #2d213f, 0 0 5px #8bbbae";
})

cntctLink.addEventListener("mouseleave", (e) => {
    e.target.style.textShadow = "0px 0px 0px #ECECFA, 0 0 0px #ECECFA, 0 0 0px #ECECFA";
})
